...
```
bash -c "$(curl -fsSL https://raw.github.com/mauricelorenz/francinette/master/bin/install.sh)"
```
...
```
bash -c "$(curl -fsSL https://raw.github.com/mauricelorenz/francinette/master/bin/update.sh)"
```
